...
import 'package:cooktique/screens/auth/login_screen.dart'; // import halaman login
import 'package:cooktique/screens/recipe/home_screen.dart'; // Tambahkan import ini jika dibutuhkan untuk navigasi Home
...
class _ProfileScreenState extends State<ProfileScreen> {
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween, // Diubah agar muat ikon menu hamburger di kanan
                  children: [
                    TextButton.icon(
                      onPressed: () {
                    ...
                    IconButton(
                      icon: const Icon(Icons.menu, color: Color(0xFF3C2415), size: 28),
                      onPressed: () {
                        // Aksi Menu Hamburger
                      },
                    ),
  ...
  // ✨ MODIFIKASI NAVITEM AGAR BISA PINDAH HALAMAN
        ...
        if (!isActive) {
          if (label == "Home") {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => const HomeScreen()), // Pastikan HomeScreen terimport
            );
          } else if (label == "Pantry" || label == "Create") {
            ScaffoldMessenger.of(context).showSnackBar(

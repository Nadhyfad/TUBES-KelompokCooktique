...
import 'package:cooktique/screens/profile/profile_screen.dart';
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Gagal mengakses kamera/galeri. Silakan periksa izin aplikasi di Pengaturan HP Anda."),
          ...
          child: Column(
            ...
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  "Pilih Sumber Foto",
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF3C2415)),
                ),
              ),
              ListTile(
                leading: const Icon(Icons.camera_alt_rounded, color: Color(0xFF9E8E84)),
              ...
              ListTile(
                leading: const Icon(Icons.image_rounded, color: Color(0xFF9E8E84)),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                icon: const Icon(Icons.add_circle, color: Color(0xFFB0B0B0)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (message.text.isNotEmpty)
                        Text(
                          message.text,
                          style: const TextStyle(color: Color(0xFF2C2C2C), fontSize: 14, height: 1.4),
                        ),
                    ],
                  ),
                ),
                const SizedBox(height: 4),
                Text(message.time, style: const TextStyle(color: Color(0xFF939393), fontSize: 10)),
              ],
            ),
          ),
          if (message.isUser) ...[
      ...
      child: Row(
        children: [
          Container(
            width: 36,
            height: 36,
            decoration: const BoxDecoration(color: Color(0xFF3C2415), shape: BoxShape.circle),
          ...
          const Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Ai Assistant', style: TextStyle(color: Color(0xFF3C2415), fontSize: 26, fontWeight: FontWeight.w600)),
              Text('Keep track of your ingredients', style: TextStyle(color: Color(0xFF6C6F7F), fontSize: 13)),
            ],
          ),
        ],
      ),
    ...
    return Row(
      ...
      children: [
        ...
        _buildNavItem(Icons.add_box_outlined, 'Create', () {
          Navigator.pushReplacement(
            context, 
            MaterialPageRoute(builder: (context) => CreateRecipeMenuScreen()),
          );
        }),
        // 5. Tombol Profile
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          Text(label, style: const TextStyle(color: Color(0xFF6A7282), fontSize: 10)),
        ],
      ),
    );
  }

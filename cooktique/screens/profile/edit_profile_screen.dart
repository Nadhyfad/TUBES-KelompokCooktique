...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void _saveProfile() {
    ...
    // Navigator.pop(context) di sini dihapus karena sudah di-handle oleh onUpdate di profile_screen.dart
  }
  ...
  ImageProvider _getProfileImage(String path) {
    ...
    // Jika berjalan di browser/web, gunakan NetworkImage untuk blob/path local web
    if (kIsWeb) {
      return NetworkImage(path);
    }
    
    // Jika di Android/iOS, baru aman menggunakan FileImage
